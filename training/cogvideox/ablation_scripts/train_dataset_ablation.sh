...
frame_interval=1
mask_controlnet_path="/datadrive2/cogvideox/mask/Pexels_MeViS_MOSE_DAVIS/Controlnet/checkpoint-17000.pt"
output_dir="/datadrive2/cogvideox/box-ablation-dataset/MeVis_MOSE/Controlnet"
