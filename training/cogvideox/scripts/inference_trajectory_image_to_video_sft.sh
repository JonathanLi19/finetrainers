...
MODEL_PATH="/datadrive2/cogvideox/mask/DAVIS/Trajectory_DiT/cogvideox-sft__optimizer_adamw__steps_10000__lr-schedule_cosine_with_restarts__learning-rate_1e-4/checkpoint-100"
...
python training/cogvideox/I2V_inference_trajectory.py \
    ...
    --height 480 \
    --width 720 \
    --output_path "samples/mask_condition/balloon_mask_step100_trajectoryscale_8.mp4"