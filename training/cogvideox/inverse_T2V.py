...
from schedulers.ddpm_scheduler import ModifiedCogvideoXDPMScheduler
...
def main(args):
    ...
    if args.validation_prompt and args.num_validation_videos > 0:
        ...
        for validation_image, validation_prompt, validation_trajectory_map in zip(validation_images, validation_prompts, validation_trajectory_maps):
            ...
            # bounding_boxes = []
            # first_frame_boxes = []
            # bounding_box, first_frame_bounding_box = load_frames_as_tensor("/home/qid/quanhao/workspace/Open-Sora/assets/boxs_trajectory/boat/moved_boxes", num_frames)
            ...
            output_path = "samples/inverse/boat_t2v_5b_50_latentshift.mp4"
